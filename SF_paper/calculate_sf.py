...
file = h5.File('SF_TEST/2_512_A2/in/T.Fr.h5', 'r')
...
file3 = data_writer.save_h5(sf_f, 'SF_TEST/2_512_A2/out/SF_Grid_scalar_mine.h5', 'SF_Grid_scalar2')
file3.close()
file.close()
...
# file3 = data_writer.save_h5(sf_f, 'SF_TEST/2_512_A2/out/SF_Grid_scalar_mine_periodic.h5', 'SF_Grid_scalar2')
# file3.close()
# file.close()
